...
PREREG=ROOT/'INSACERMO_CSPMINIZINCTIME2016_BLIND_PLANNER_PREREG_V1.json'
OUT=ROOT/'cspminizinctime2016_blind_planner_v1_output'; OUT.mkdir(exist_ok=True)
RAW='https://raw.githubusercontent.com/coseal/aslib_data/master/CSP-Minizinc-Time-2016/'
...
def main():
    ...
    # Parser-only compatibility fix. This ASlib scenario declares PAR10 as its runtime
    # performance measure. For successful (runstatus=ok) runs, PAR10 equals observed
    # runtime; timeouts are penalized and in any case rejected by runstatus != ok.
