...
PREREG=ROOT/'INSACERMO_CSPMINIZINCOBJ2016_BLIND_PLANNER_PREREG_V1.json'
OUT=ROOT/'cspminizincobj2016_blind_planner_v1_output'; OUT.mkdir(exist_ok=True)
RAW='https://raw.githubusercontent.com/coseal/aslib_data/master/CSP-Minizinc-Obj-2016/'
